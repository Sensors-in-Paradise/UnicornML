...
from models.CustomPreprocessingModel import CustomPreprocessingModel
...
# Init, Preprocessing in model
model = CustomPreprocessingModel(window_size=25, n_features=recordings[0].sensor_frame.shape[1], n_outputs=6, verbose=1, n_epochs=3)
