...
from evaluation.text_metrics import create_text_metrics_for_threshold_accuracy, create_text_metrics
...
# Init
data_config = OpportunityConfig(dataset_path="dataset/OpportunityUCIDataset")
...
create_text_metrics_for_threshold_accuracy(
