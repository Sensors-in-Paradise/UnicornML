...
for tl_sub in subs:
    ...
    recordings_train, recordings_tl = recordings.split_leave_subject_out(tl_sub)
    ...
    if target_sampling_rate != None:
        print(f"...Resampling")
        recordings_train.resample(target_sampling_rate, base_sampling_rate, show_plot=True, path=experiment_folder_path_tl)
    ...
    for model_idx, model in enumerate(models):
        ...
        experiment_folder_path_tl_model = os.path.join(experiment_folder_path_tl, base_model.model_name)
